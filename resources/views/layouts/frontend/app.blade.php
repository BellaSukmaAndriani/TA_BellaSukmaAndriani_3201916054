...
<head>
    ...
    <!-- Title -->
    <title>Welcome Ukhwahfillah | {{ $title ?? '' }}</title>

    <!-- Favicon -->
    <link rel="icon" href="{{ asset('templates/frontend/clever') }}/img/core-img/man.ico">
...
<body>
    ...
    <header class="header-area">
        ...
        <!-- Top Header Area -->
        <div class="top-header-area d-flex justify-content-between align-items-center" style="background-color:#a1c5a5;">
            <!-- Contact Info -->
            <div class="contact-info">
                {{-- <a href="#"><span>hbdchbfue</a>
                <a href="#"><span>jdwdhuwgdui</a> --}}
            </div>
            <!-- Follow Us -->
            <div class="contact-info">
                {{-- <a href="#"><span>hbdchbfue</a> --}}
