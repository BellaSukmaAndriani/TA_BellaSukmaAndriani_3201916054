@extends('layouts.backend.app', [
    'title' => 'Tambah Data Guru dan Santri',
    'contentTitle' => 'Data Guru dan Santri',
])
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="file" name="Gambar" class="dropify form-control"
                                data-height="250" data-allowed-file-extensions="png jpg gif jpeg svg webp jfif" required>
                        </div>
                    </div>
                    <div class="form-group">
