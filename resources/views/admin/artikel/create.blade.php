    ...
    <div class="">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Masukkan Kegiatan Pada Pondok Pesantren Tahfidz Al Quran El 'Amani Pontianak</h4>
            </div>
            <div class="card-body">
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.artikel.store') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input required="" type="" name="judul" placeholder="" class="form-control" required>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
