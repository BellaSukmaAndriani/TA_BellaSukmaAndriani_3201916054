@extends('layouts.backend.app', [
    'title' => 'Manage Jenis Kajian',
    'contentTitle' => 'Manage Jenis Kajian',
])
@push('css')
    <!-- DataTables -->
    <link rel="stylesheet"
                        ...
                        <tbody>
                            ...
                            @foreach ($kategoriArtikel as $ktgArt)
                                <tr>
                                    ...
                                    <td>
                                        <div class="row ml-2">
                                            <a href="{{ route('admin.kategori-artikel.edit', $ktgArt->id) }}"
                                                class="btn btn-primary btn-sm"><i class="fas fa-edit fa-fw"></i></a>

                                            <form method="POST"
                                                action="{{ route('admin.kategori-artikel.destroy', $ktgArt->id) }}">
                                                @csrf
                                                @method('DELETE')
