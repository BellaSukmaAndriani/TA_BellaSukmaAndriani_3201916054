@extends('layouts.backend.app', [
    'title' => 'Tambah Kategori Donasi',
    'contentTitle' => 'Tambah Kategori Donasi',
])
    ...
    <div class="">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('Kelola-Donasi') }}" class="btn btn-success btn-sm">Kembali</a>
            </div>
            <div class="card-body">
                <form action="{{ route('donasi.store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <input required="" type="" name="judul" placeholder="" class="@error('judul') is-invalid @enderror form-control title">
